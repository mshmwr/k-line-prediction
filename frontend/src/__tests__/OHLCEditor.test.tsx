...
const emptyRows = (n: number): OHLCRow[] =>
  Array.from({ length: n }, () => ({ open: '', high: '', low: '', close: '' }))

test('renders N rows of OHLC inputs', () => {
  render(<OHLCEditor rows={emptyRows(5)} onChange={() => {}} />)
