...
│   │           │   ├── PageHeaderSection.tsx             ← S1 One operator 聲明（K-022 三層拆法；K-034 Phase 2 D-19/D-20/D-21 改左對齊 2-line hero ink+brick + 全寬 divider + gap-18 flex column）
